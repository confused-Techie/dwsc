/**
  Logging Class:
    Logs messages in a format compatible with [GELF](https://go2docs.graylog.org/current/getting_in_log_data/gelf.html).
    Supports any number of `sendMethods`. Calling the API `.addLogMethod()` with a function will ensure that
    function is called whenever a new log is available, ensuring full customizability.
*/
